...
### 1번 [패턴마디](https://swexpertacademy.com/main/code/problem/problemDetail.do?problemLevel=2&contestProbId=AV5P1kNKAl8DFAUq&categoryId=AV5P1kNKAl8DFAUq&categoryType=CODE&problemTitle=&orderBy=RECOMMEND_COUNT&selectCodeLang=ALL&select-1=2&pageSize=10&pageIndex=2)

-   패턴에서 반복되는 부분을 마디라고 부른다
-   문자열길이 30 마디의 최대길이 10
-   첫줄 테케 개수 T, 그 아래로 태케

-   어캐풀지
    -   반복되는 단어를 구분하는법이 뭘까?
        -   떠오른 생각
            -   길이가 30인 문자열이라는 말이 중요한거같음
                -   문자열을 쌓아서 변환시켜서 0이되면?
